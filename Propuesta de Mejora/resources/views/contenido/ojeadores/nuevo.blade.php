...
@section('title', 'Crear Ojeador')

@section('content')
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">

<div class="container mt-4 bg-white p-4 rounded ">
    <h2 class="h4 mb-4 text-dark">Nuevo Perfil de Ojeador</h2>
    
    <form action="{{ route('ojeadores.crear') }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="mt-4 pt-3 border-top d-flex gap-2">
            ...
            <a href="{{ route('ojeadores.principal') }}" class="btn btn-secondary px-4">
