...
<div class="container mt-4 bg-white p-4 rounded ">
    <h2 class="h4 mb-4 text-dark">Nuevo Perfil de un Agente</h2>
    
    <form action="{{ route('agentes.crear') }}" method="POST">
        @csrf
        @method('PUT')
            ...
            <div class="col-md-6">
                ...
                <select name="Usuario" class="form-select">
                    ...
                    @forelse ($usuarios as $usuario)
                        <option value="{{ $usuario->ID_Usuario }}" @selected(old('Usuario') == $usuario->ID_Usuario)>
        ...
        <div class="mt-4 pt-3 border-top d-flex gap-2">
            ...
            <a href="{{ route('agentes.principal') }}" class="btn btn-secondary px-4">
