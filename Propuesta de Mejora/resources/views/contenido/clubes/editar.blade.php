...
<div class="container mt-4 bg-white p-4 rounded ">
    <h2 class="h4 mb-4 text-dark">Editar Perfil de {{$club->Nombre}}</h2>
    
    <form action="{{ route('clubes.actualizar', ['id' => $club->ID_Club]) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="Nombre" value="{{ old('Nombre', $club->Nombre) }}" class="form-control">
            </div>
            ...
            <div class="col-md-6">
                ...
                <select name="Pais" class="form-select">
                    ...
                    @foreach ($paises as $pais)
                        <option value="{{ $pais->ID_Pais }}" {{ $club->Pais == $pais->ID_Pais ? 'selected' : '' }}>
            ...
            <div class="col-md-6">
                ...
                <div class="input-group">
                    <input type="text" name="url_logo" value="{{ old('url_logo', $club->url_logo) }}" class="form-control">
            ...
            <div class="mt-3 text-center">
                @if(old('url_logo') || isset($club->Foto_Perfil))
                    <img src="{{ old('url_logo') }}" 
                        class="img-thumbnail" style="width: 3em; height: 4em; object-fit: fill;">
                @else
            ...
            <div class="col-md-6">
                ...
                <select name="Usuario" class="form-select">
                    ...
                    @forelse ($usuarios as $usuario)
                        <option value="{{ $usuario->id }}" @selected(old('Usuario', $club->Usuario) == $usuario->id)>
        ...
        <div class="mt-4 pt-3 border-top d-flex gap-2">
            ...
            <a href="{{ route('clubes.ver', ['id' => $club->ID_Club]) }}" class="btn btn-secondary px-4">
