...
<head>
    ...
    <title>Jugador - @yield('title')</title>
    ...
    <div class="offcanvas offcanvas-start bg-dark text-white" tabindex="-1" id="sidebarMobile">
        ...
        <div class="offcanvas-body p-3">
            <ul class="nav nav-pills flex-column mb-auto">
                <li><a href="{{ route('dashboard') }}" class="nav-link {{ request()->is('/') ? 'active' : '' }}"><i class="bi bi-house-door me-2"></i>Dashboard</a></li>
                <li><a href="{{ route('jugador.perfil') }}" class="nav-link {{ request()->is('jugador/perfil') ? 'active' : '' }}"><i class="bi bi-person-circle me-2"></i>Mi Perfil</a></li>
            </ul>
